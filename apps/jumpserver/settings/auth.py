...
OTP_IN_API = CONFIG.OTP_IN_API
OTP_SERVER_URL = CONFIG.OTP_SERVER_URL
OTP_SERVER_PARAMS = CONFIG.OTP_SERVER_PARAMS
OTP_SSH_KEY_SKIP = CONFIG.OTP_SSH_KEY_SKIP
OTP_SESSION_REUSE = CONFIG.OTP_SESSION_REUSE
OTP_SESSION_REUSE_LIMIT_TIME = CONFIG.OTP_SESSION_REUSE_LIMIT_TIME
